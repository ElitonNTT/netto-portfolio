export default function Projetos() {
  return (
    <div id="projetos" className="container layoutSections">
      ...
      <div className="projetos">
        ...
        <div className="cards">
          ...
          <div className="titulo-projeto">GERADOR QRCODE</div>
        </div>
        <div className="cards">
        ...
        <div className="cards">
          ...
          <div className="titulo-projeto">LOGIN PAGE</div>
        </div>
        <div className="cards">
          <img src="https://picsum.photos/200/300" alt="JOGO DA VELHA" />
          <div className="titulo-projeto">JOGO DA VELHA</div>
        </div>
      </div>
    </div>
  );
